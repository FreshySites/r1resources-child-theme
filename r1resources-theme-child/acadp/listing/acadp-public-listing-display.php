	...
	<div class="row">    	
        ...
        <div class="<?php echo $has_sidebar ? 'col-md-8' : 'col-md-12'; ?>">  
            ...
            <?php if ( $can_show_images ) : $images = unserialize( $post_meta['images'][0] ); ?>
				<?php if ( 1 == count( $images ) ) : $image_attributes = wp_get_attachment_image_src( $images[0], 'medium' ); ?>
                    <p>
                        <a class="acadp-image-popup" href="<?php echo esc_url( $image_attributes[0] ); ?>">
                            <img src="<?php echo esc_url( $image_attributes[0] ); ?>" alt="" style="max-width:250px !important;"/>
                        </a>
                    </p>
                <?php else : ?>
        ...
        <?php if ( $has_sidebar ) : ?>
            <div class="col-md-4">
                <!-- SHARE THIS LISTING -->
                <a href=""class="popmake-6612 btn btn-default"><h5><i class="fa fa-envelope"></i> Share This Vendor Listing</h5></a>
                <p></p>
