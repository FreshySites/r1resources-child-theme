...
// PREVENT VENDORS FROM VIEWING PAGES OTHER THAN VENDOR FORM - EMK 5-8-22
$userID = get_current_user_id();
$currentpage = $_SERVER['REQUEST_URI'];
if ( $userID == '1343' && is_user_logged_in() && $currentpage != 'https://r1resources.com/vendor-new-listing-form/') {
  header("Location:https://r1resources.com/vendor-new-listing-form/");
  exit();
}
