			...
			<li <?php bp_member_class( array( 'item-entry' ) ); ?> data-bp-item-id="<?php bp_member_user_id(); ?>" data-bp-item-component="members">
				...
				">
					...
					<div class="list-wrap-inner">
						...
						<div class="member-location-wrap" style="text-align: center; margin-top: -10px;">
								<?php 
									$member_state = xprofile_get_field(89, bp_get_member_user_id())->data->value;

									if ($member_state != '') {
										echo '<span class="state" style="font-size: 12px">' . $member_state . '</span>';
									}
								?>
						</div>

						<div class="member-buttons-wrap">
								<div class="flex only-grid-view button-wrap member-button-wrap footer-button-wrap" style="justify-content: space-evenly;padding: 5px 0;">
									<?php 
										$member_email = bp_core_get_user_email(bp_get_member_user_id());
										$member_phone = xprofile_get_field(77, bp_get_member_user_id())->data->value;

										echo '<div><a href="mailto:' . $member_email . '"><i class="fa fa-envelope"></i></a></div>';
										if ($member_phone != '') {
											echo '<div><a href="tel:' . $member_phone . '"><i class="fa fa-phone"></i></a></div>';
										}
									?>
								</div>
